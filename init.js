    ...
    WhWidgetSendButton = function() {
        ...
        return a.getMetricsIframeId = function() {
            ...
            if (b = b.replace("whatshelp.io", "getbutton.io"), b = b.replace("wh.test", "getbutton.test"), a.checkParams(b, c, d)) {
                ...
                d = WidgetInitializer.checkAndClearProOptions(d, window.location.hostname), WidgetDetect.isMobile() && d.hasOwnProperty("mobile") && !1 === d.mobile || !WidgetDetect.isMobile() && d.hasOwnProperty("desktop") && !1 === d.desktop || (WidgetInitializer.widgetInitialize("container", e, d), setTimeout(function() {
                    a.prepareForSmallScreen()
                }, 3e3), window.addEventListener("resize", function() {
            ...
            for (var a = {
                ...
                }, b = 0; b < window.frames.length; b++) window.frames[b].postMessage(JSON.stringify(a), "*")
        }, a
    }();
...
var WidgetSendButtonContainer = function() {
    ...
    return a.prototype.reInitWidget = function(a) {
        ...
        if (b) {
            ...
            if (!WidgetDetect.isMobile() && WidgetDetect.isChromeBasedBrowser() && c && d && a.width < 290) return b.style.width = "290px", void(b.style.height = a.height.toString() + "px");
            b.style.width = a.width.toString() + "px", b.style.height = a.height.toString() + "px"
        }
        ...
        b.id = a.getIframeId(this.params.wrapperId), b.setAttribute("src", this.getWidgetUrl()), b.setAttribute("name", "IGetButton");
